            ...
            <main className="flex-1 flex items-center justify-center p-4">
                <div className="w-full max-w-sm mx-auto">
                    ...
                    <div className="text-center mb-8">
                        ...
                        <p className="font-body-md text-body-md text-on-surface-variant/70 mt-3">Quên mật khẩu</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit}
                        ...
                        <div className="text-center pt-4 border-t border-outline-variant/20">
                            <Link to="/login" className="text-primary font-semibold hover:underline flex items-center justify-center gap-1 text-sm">
