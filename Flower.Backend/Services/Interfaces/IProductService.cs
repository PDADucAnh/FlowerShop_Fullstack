...
namespace Flower.Backend.Services.Interfaces
{
    public interface IProductService
    {
        ...
        Task<PagedResult<ProductDTO>> GetPaged(int page, int pageSize, decimal? minPrice = null, decimal? maxPrice = null, int? categoryProductId = null, bool includeInactive = false);
